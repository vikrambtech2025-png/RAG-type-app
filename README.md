...
A powerful Retrieval-Augmented Generation (RAG) application that allows you to chat with your documents using local or cloud-based LLMs.

## 🚀 Overview

RAG Chat enables users to upload various document formats and query them using advanced AI models. It uses a sophisticated indexing pipeline to break down documents into searchable chunks, ensuring accurate and context-aware responses.
